...
@section('section')
                <main role="main" class="ml-sm-auto col-lg-10">
                    ...
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        <h1 class="h2">Quản lý comment</h1>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="post_title" href="" style="color: #055699;">{{$row->idphongtro}} </a>
                                        </td>
                                        <td>{{$row->idnguoithuephong}} </td>
                                        <td>{{$row->comment}}</td>
                                        <td>
                                        <a href="/blog/public/admin/duyetcomment/{{$row->id}}" style="color: #055699;">{{$row->duyetcomment}} </a>
                                        </td>
