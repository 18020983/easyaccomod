                                ...
                                <div class="single-product clearfix">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            ...
                                            <form action="" method="post">
                                                <button class=" btn btn-danger btn-add-cart pro-label new-label" style="padding: 0 10px;margin-right: 30px;background-color: #F7931E;">
                                                    <span uk-icon="icon: heart; ratio: 0.5"></span> 50
                                                </button>
                                            </form>
